...
export const handleBattle = async (
  ...
  try {
    ...
    initialEmbed.setAuthor(interaction.user.tag.toString(), interaction.user.displayAvatarURL());
    ...
    collector.on("collect", async (click) => {
      ...
      resultEmbed.setAuthor(interaction.user.tag.toString(), interaction.user.displayAvatarURL());
